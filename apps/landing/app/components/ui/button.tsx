...
/**
 * [SYNTHTABLE_BUTTON] Vendored from shadcn/ui (Button) and re-themed against
 * the SynthTable tokens. Square edges, ink fill, ember on hover. The source
...
const variantClasses: Record<ButtonVariant, string> = {
  // [SYNTHTABLE_DARK_PIVOT 2026-05-08] Re-tuned for graphite canvas.
