...
| Objection | Response |
|-----------|----------|
| "Synthetic data isn't real data." | Correct. We don't pretend it is. Foundry/7 is best for cold-start, eval, edge-case augmentation, and privacy-safe clones. The manifest tells you exactly where the dataset can be trusted. |
