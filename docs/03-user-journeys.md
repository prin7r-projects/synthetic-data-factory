...
|------|-------|--------------|
| 1 | Twitter / X | Mei sees a SynthTable thread on benchmark reproducibility (a manifest screenshot, not a logo) and clicks through. |
...
| 7 | Email | SynthTable-engineer pings her in Slack within 4 hours; they paste a draft schema for medical-coding. |
...
| Step | Where | What happens |
|------|-------|--------------|
| 1 | Hacker News / `r/MachineLearning` | Sees a comment recommending SynthTable over a competitor. Clicks. |
...
| Step | Where | What happens |
|------|-------|--------------|
| 1 | LinkedIn | Reads a SynthTable post on HIPAA-style synthetic clones. |
...
| 6 | SynthTable ops | Cuts a manual EUR invoice; Plisio fallback offered if she changes her mind. |
