...
| Partnerships with eval frameworks (Inspect, Promptfoo, Weave, Phoenix) | — | tracked | Co-launch templates: "Eval set + Foundry/7 generator in a pull request." |
...
### Hacker News
A "Show HN: Foundry/7 — synthetic datasets with row-level provenance" launch
